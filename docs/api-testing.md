...
## 📥 Direct Import Collection (v3.8.2)
...
```json
{
	"info": {
		...
		"name": "WhatsApp Bridge Service (v3.8.2)",
		"description": "Comprehensive collection for testing v3.8.2 features: Messaging, MFA Auth, Session Management, and Administrative Purging.",
