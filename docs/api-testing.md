...
## 📥 Direct Import Collection (v3.8.3)
...
```json
{
	"info": {
		...
		"name": "WhatsApp Bridge Service (v3.8.3)",
		"description": "Comprehensive collection for testing v3.8.3 features: Messaging, MFA Auth, Session Management, and Administrative Purging.",
