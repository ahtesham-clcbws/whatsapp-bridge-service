...
## 📥 Direct Import Collection (v3.8.4)
...
```json
{
	"info": {
		...
		"name": "WhatsApp Bridge Service (v3.8.4)",
		"description": "Comprehensive collection for testing v3.8.4 features: Messaging, MFA Auth, Session Management, and Administrative Purging.",
