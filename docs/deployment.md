...
## 🆙 8. Modernizing Your Bridge (v3.8.1 Update)
...
Once updated, visit your Admin Dashboard and check the footer. It should report **v3.8.1**. Your existing templates and logs will be preserved automatically.
