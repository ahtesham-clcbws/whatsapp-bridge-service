# Remote Session Management (v3.8.5)
...
- **MFA Protection**: In v3.8.5, all session management functions via the dashboard are protected by **WhatsApp-Native MFA**. Attempts to logout or fetch QR strings require a valid OTP.
